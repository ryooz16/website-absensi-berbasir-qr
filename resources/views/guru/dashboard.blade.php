<x-app-layout>
    ...
    <div class="p-6 lg:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="{{ route('guru.scan') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
            ...
            <a href="{{ route('guru.riwayat-absensi') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
                <div class="flex items-center gap-4">
            ...
            <a href="{{ route('guru.absensi-siswa.index') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
                <div class="flex items-center gap-4">
            ...
            @if($kelasWali)
            <a href="{{ route('guru.laporan-kelas') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600">
            ...
            <a href="{{ route('guru.rekap-absensi.index') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
                <div class="flex items-center gap-4">

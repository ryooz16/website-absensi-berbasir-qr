        ...
        <div class="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-slate-200 mb-8" x-data="{ periode: '{{ $periodeAktif ?? 'hari_ini' }}' }">
            <form action="{{ route('wakepsek.laporan.siswa.index') }}" method="GET" class="space-y-4">
                ...
                <div class="flex flex-col md:flex-row justify-end gap-3 pt-4 border-t border-slate-100 mt-4">
                    ...
                    <a href="{{ route('wakepsek.laporan.siswa.index') }}" class="w-full md:w-auto px-5 py-2.5 rounded-xl text-sm font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 transition text-center">
                        Reset
                    </a>
                    @endif
                    ...
                    <a href="{{ route('wakepsek.laporan.siswa.export', request()->all()) }}" class="w-full md:w-auto px-5 py-2.5 rounded-xl text-sm font-bold text-emerald-700 bg-emerald-100 hover:bg-emerald-200 transition flex items-center justify-center gap-2">
